    ...
    <main class="main">
        <div class="main__inner">
            <div class="main__inner-item">
                <h1 class="main__inner-item--title">ログイン</h1>
            </div>
            <div class="main__inner-item">
                <form class="main__inner-item--form" action="/login" method="POST">
                    ...
                    <div class="form__group">
                        <button class="form__group--button" type="submit">ログインする</button>
                    </div>
                </form>
                <div class="main__inner-item--register">
                    <a class="main__inner-item--register-link" href="{{ route('register') }}">会員登録はこちら</a>
                </div>
            </div>
        </div>
    </main>
